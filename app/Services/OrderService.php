    ...
    public function get_all(User $user)
    {
        ...
        $posts->getCollection()->each(
            function ($post) use (
                ...
                $user_feedback = $post->user->id != $user->id
                ...
                if ($post->type == 'item') {
                    array_push($items, [
                        ...
                        'post_user_id' => $post->user->id == $user->id ? $post->bids[0]->user->id : $post->user->id,
                        'post_user_uid' => $post->user->id == $user->id ? $post->bids[0]->user->uid : $post->user->uid,
                        'post_user_name' => $post->user->id == $user->id ? $post->bids[0]->user->full_name : $post->user->full_name,
                        'post_user_avatar' => $post->user->id == $user->id ? $post->bids[0]->user->avatar : $post->user->avatar,
