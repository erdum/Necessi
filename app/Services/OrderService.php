            ...
            function ($post) use (
                ...
                if ($post->type == 'item') {
                    array_push($items, [
                        ...
                        'post_user_name' => $post->user->id == $user->id ? $post->bids[0]->user->full_name : $user->full_name,
                        'post_user_avatar' => $post->user->id == $user->id ? $post->bids[0]->user->avatar : $user->avatar,
